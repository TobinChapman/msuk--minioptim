...
def main():
    ...
    weeks_in = st.number_input("# of weeks", value=None, step=1, placeholder="Type a number...")
    budget_in = st.number_input("Total budget", value=None, step=1, placeholder="Type a number...")
